...
import inventormod.powers.ClockworkAssistantPower;

public class ClockworkAssistant extends AbstractInventorCard {
    public static final String ID = "ClockworkAssistant";
