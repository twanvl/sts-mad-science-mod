...
import inventormod.actions.common.PlayTopCardAction;

public class ClockworkAssistantPower extends AbstractPower {
    public static final String POWER_ID = "ClockworkAssistant";
