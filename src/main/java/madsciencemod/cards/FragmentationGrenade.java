...
public class FragmentationGrenade extends AbstractMadScienceCard {
    public static final String ID = "MadScienceMod:FragmentationGrenade";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ShuffleTrinketAction(this.magicNumber, true, true, this.upgraded));
    }
