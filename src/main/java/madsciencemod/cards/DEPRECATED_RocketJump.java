...
public class DEPRECATED_RocketJump extends AbstractMadScienceCard {
    public static final String ID = "MadScienceMod:DEPRECATED_RocketJump";
    ...
    public AbstractCard makeCopy() {
        return new DEPRECATED_RocketJump();
    }
